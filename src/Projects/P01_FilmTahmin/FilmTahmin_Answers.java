...
public class FilmTahmin_Answers {
    ...
    private static void filmGetir(List<String> film, int index) {
        //   Scanner scan = new Scanner(System.in);
        StringBuilder tahminEdilecekFilm = new StringBuilder(FilmTahmin_Answers.filmler.get(index).replaceAll("\\w", "-"));//tum harf karakterleri - ile değiştir
